    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_Aceptar.setOnClickListener {
            ...
            if (nombreUsuarioIntroducido.isEmpty()) {
                ...
                if(consultarExistenciaUsuario(nombreUsuarioIntroducido)){
                    Toast.makeText(this, R.string.LO_Toast_NombreUsuarioExiste, Toast.LENGTH_SHORT).show()
                }
                //Aquí hay que comprobar que el numero de colegiado no exista en bbdd
                //Hay quecrear la Api para las consultas de la tabla médicos
                //Hayq ue pasar el valor del num. colegiado al siguiente activity
            }
        }
    }
