...
class ModeloIA(private val context: Context) {
    ...
    private fun getClassName(predictedIndex: Int): String {
        val classResIds = listOf(
            R.string.ModeloIA_Melanoma,
            R.string.ModeloIA_Nevus,
            R.string.ModeloIA_Angioma,
            R.string.ModeloIA_Dermatofibroma,
            R.string.ModeloIA_Onicomicosis
        )

        return if (predictedIndex in classResIds.indices) {
            context.getString(classResIds[predictedIndex])
        } else {
            context.getString(R.string.ModeloIA_Desconocido)
        }
    }
